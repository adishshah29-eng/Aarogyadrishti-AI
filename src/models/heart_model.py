...
def train_and_evaluate():
    # Load processed data
    data_path = r"c:\Users\Sayli\OneDrive\Desktop\Aarogyadrishti-AI\data\processed\heart_clean.csv"
    ...
    checkup_safe_features = ['age', 'sex', 'systolic_bp', 'cholesterol']
    target_col = 'target'
    ...
    print("Training Baseline Heart Model (5-fold CV)...")
    ...
    print("Training Checkup-safe Heart Model (5-fold CV)...")
    ...
    print("\n=== Heart Baseline Model Performance ===")
    print(f"Accuracy: {base_acc:.4f}")
    print(f"ROC AUC:  {base_auc:.4f}")
    print(f"F1-Score: {base_f1:.4f}")
    print("Confusion Matrix:\n", base_conf)
    
    print("\n=== Heart Checkup-Safe Model Performance ===")
    ...
    print("\nTraining final checkup-safe Heart model on entire dataset...")
    smote = SMOTE(random_state=42)
    ...
    print(f"Saved checkup-safe Heart model to {model_path}")
...
def _load_model_data():
    model_path = r"c:\Users\Sayli\OneDrive\Desktop\Aarogyadrishti-AI\models\heart_model.pkl"
