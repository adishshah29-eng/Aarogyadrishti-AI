...
def train_and_evaluate():
    # Load processed data
    data_path = r"c:\Users\Sayli\OneDrive\Desktop\Aarogyadrishti-AI\data\processed\hypertension_clean.csv"
    ...
    checkup_safe_features = ['age', 'sex', 'bmi', 'systolic_bp', 'diastolic_bp', 'cholesterol', 'glucose', 'smoking', 'alcohol', 'physical_activity']
    target_col = 'cardio'
    ...
    # XGBoost hyperparameters (using subsample for speed on 70k rows)
    xgb_params = {
        'n_estimators': 100,
        'max_depth': 4,
        'learning_rate': 0.1,
    ...
    print("Training Baseline Hypertension Model (5-fold CV)...")
    ...
    print("Training Checkup-safe Hypertension Model (5-fold CV)...")
    ...
    print("\n=== Hypertension Baseline Model Performance ===")
    print(f"Accuracy: {base_acc:.4f}")
    print(f"ROC AUC:  {base_auc:.4f}")
    print(f"F1-Score: {base_f1:.4f}")
    print("Confusion Matrix:\n", base_conf)
    
    print("\n=== Hypertension Checkup-Safe Model Performance ===")
    ...
    print("\nTraining final checkup-safe Hypertension model on entire dataset...")
    smote = SMOTE(random_state=42)
    ...
    print(f"Saved checkup-safe Hypertension model to {model_path}")
...
def _load_model_data():
    model_path = r"c:\Users\Sayli\OneDrive\Desktop\Aarogyadrishti-AI\models\hypertension_model.pkl"
